...
- Explore the [Event-First Architecture](/indexer/domain-architecture/event-first) in detail
- Review the [Architecture Overview](/indexer/domain-architecture/overview) for the complete picture
- Check how events are processed in each domain
- Review the [REST API](/indexer/api-endpoints/rest-api) endpoints for domain queries
